...
DROP FUNCTION get_price(tour_id integer)
CREATE OR REPLACE FUNCTION get_price(tour_id integer) RETURNS table(price integer)
as
$$
...
DROP FUNCTION Booking(tourist_id INT,tour_id INT,booking_date DATE);
